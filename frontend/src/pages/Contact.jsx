...
import { useForm } from "react-hook-form";BiZoomIn
...
function Contact() {
  ...
  const onSubmit = async (data) => {
    const userInfo = {
      access_key: "02bcfd7e-ab60-4c1b-b139-297e2259e477",
      name: data.username,
      email: data.email,
            ...
            <div className="w-full md:w-1/2 md:pl-4">
              ...
              <ul className="space-y-4">
                <li className="flex items-center space-x-2">
                  ...
                  <span>+91 8643041429, +91 6260578509</span>
                </li>
                <li className="flex items-center space-x-2">
                  <FaEnvelope className="text-pink-500" />
                  <span>aryanpathak0421@gmail.com</span>
                </li>
                <li className="flex items-center space-x-2">
